...
- 성공 여부 확인이 실패할 시, 데이터베이스 `pendings` 테이블에 해시를 아카이빙한 후 1시간마다 크론(깃허브 액션)으로 재추적합니다.
- `EIP-1559` 표준에 맞춰 트랜잭션 가스비를 설정하되, 빠른 트랜잭션 처리를 위해 블록 [`base fee`의 2배를 설정](https://github.com/developerasun/ricktcal-worldcup/blob/72dfa80e808ac1c0a91b20368484f433f4439c27/dapp/src/server/onchain/index.ts#L31)합니다.

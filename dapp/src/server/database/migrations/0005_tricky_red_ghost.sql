...
INSERT INTO `__new_votes`("id", "userId", "proposalId", "voteCast", "digest", "elifAmount", "signature") SELECT "id", "userId", "proposalId", "voteCast", "digest", "elifAmount", "signature" FROM `votes`;--> statement-breakpoint

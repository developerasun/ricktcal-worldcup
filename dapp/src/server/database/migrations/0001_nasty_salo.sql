...
INSERT INTO `__new_proposals`("id", "userId", "isActive", "status", "title", "description", "startAt", "endAt") SELECT "id", "userId", "isActive", "status", "title", "description", "startAt", "endAt" FROM `proposals`;--> statement-breakpoint
